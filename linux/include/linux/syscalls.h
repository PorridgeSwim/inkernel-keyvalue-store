...
asmlinkage long sys_kkv_put(uint32_t key, void __user *val, size_t size, int flags);
asmlinkage long sys_kkv_get(uint32_t key, void __user *val, size_t size, int flags);
#endif /* CONFIG_ARCH_HAS_SYSCALL_WRAPPER */
